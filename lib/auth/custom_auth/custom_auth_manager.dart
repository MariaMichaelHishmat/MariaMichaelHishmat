...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    mrAbdElrazekAuthUserSubject.add(
      MrAbdElrazekAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MrAbdElrazekAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MrAbdElrazekAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MrAbdElrazekAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    mrAbdElrazekAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
MrAbdElrazekAuthUser? currentUser;

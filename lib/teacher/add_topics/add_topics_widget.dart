...
class _AddTopicsWidgetState extends State<AddTopicsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddTopicsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<TopicsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TopicsRecord> addTopicsTopicsRecordList = snapshot.data!;
        final addTopicsTopicsRecord = addTopicsTopicsRecordList.isNotEmpty
            ? addTopicsTopicsRecordList.first
            : null;
                  ...
                  children: [
                    ...
                    FutureBuilder<List<TopicsListRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final listViewTopicsListRowList = snapshot.data!;

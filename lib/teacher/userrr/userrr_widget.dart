...
class UserrrWidget extends StatefulWidget {
  const UserrrWidget({
    super.key,
  ...
  @override
  State<UserrrWidget> createState() => _UserrrWidgetState();
}

class _UserrrWidgetState extends State<UserrrWidget> {
  late UserrrModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserrrModel());

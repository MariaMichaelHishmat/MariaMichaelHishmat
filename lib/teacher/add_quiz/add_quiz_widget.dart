  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<QuizRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<QuizRecord> addQuizQuizRecordList = snapshot.data!;
        final addQuizQuizRecord = addQuizQuizRecordList.isNotEmpty
            ? addQuizQuizRecordList.first
            : null;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await SQLiteManager.instance.addQuiz(
                                    question: _model.textController1.text,
                                    img: _model.quesphotoModel.uploadedLocalFile
                                        .blurHash,
                                    opt1: _model.textController2.text,
                                    opt1bo: _model.checkboxValue1,
                                    opt2: _model.textController3.text,
                                    opt2bo: _model.checkboxValue2,
                                    opt3: _model.textController4.text,
                                    ...
                                    correctAns: () {
                                      if (_model.checkboxValue1 == true) {
                                        return _model.textController2.text;
                                          ...
                                          true) {
                                        return _model.textController3.text;
                                      } else if (_model.checkboxValue3 ==
                                          true) {
                                        return _model.textController4.text;
                                      } else {
                                        return _model.textController5.text;
                                      }
                                    }(),
                                  );
                                  safeSetState(() {

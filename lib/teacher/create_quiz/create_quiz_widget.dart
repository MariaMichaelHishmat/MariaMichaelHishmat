...
class CreateQuizWidget extends StatefulWidget {
  /// create quiz page to enter quiz name and duration and code I want the page
  /// only contain these
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<QuizsetRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<QuizsetRecord> createQuizQuizsetRecordList = snapshot.data!;
        final createQuizQuizsetRecord = createQuizQuizsetRecordList.isNotEmpty
            ? createQuizQuizsetRecordList.first
            : null;
                  ...
                  children: [
                    ...
                    FutureBuilder<List<QuizSetListRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final buttonQuizSetListRowList = snapshot.data!;

                        return FFButtonWidget(
                          onPressed: () async {
                            await SQLiteManager.instance.addQuizset(

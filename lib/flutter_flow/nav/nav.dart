...
class AppStateNotifier extends ChangeNotifier {
  ...
  MrAbdElrazekAuthUser? initialUser;
  MrAbdElrazekAuthUser? user;
  ...
  void update(MrAbdElrazekAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'addTopics',
          path: '/addTopics',
          builder: (context, params) => AddTopicsWidget(
            chi: params.getParam(
              'chi',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: 'createtopic',
          path: '/createtopic',
          builder: (context, params) => CreatetopicWidget(
            tid: params.getParam(
              'tid',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: 'Topic_Display',
          path: '/topicDisplay',
          builder: (context, params) => TopicDisplayWidget(
            tro: params.getParam(
              'tro',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: 'qui',
          path: '/qui',
          builder: (context, params) => QuiWidget(
            tt: params.getParam(
              'tt',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: 'showset',
          path: '/showset',
          builder: (context, params) => ShowsetWidget(
            tid: params.getParam(
              'tid',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: 'vidWatch',
          path: '/vidWatch',
          builder: (context, params) => VidWatchWidget(
            vidpath: params.getParam(
              'vidpath',
              ParamType.String,
            ),
            vidn: params.getParam(
              'vidn',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: 'opentopic',
          path: '/opentopic',
          builder: (context, params) => OpentopicWidget(
        ...
        FFRoute(
          name: 'userrr',
          path: '/userrr',
          builder: (context, params) => UserrrWidget(
